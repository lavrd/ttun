...
// 100 MB.
const BufferLength: usize = 1024 * 1024 * 100;
...
fn incomingServer(
    ...
    while (shouldWait(5)) {
        ...
        var buf = try allocator.alloc(u8, BufferLength);
...
fn connectToProxyServer(allocator: std.mem.Allocator) !void {
